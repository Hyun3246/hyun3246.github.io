...
그 중 알고리즘의 발전은 계산을 더욱 효과적으로 수행할 수 있게 해주었는데, 대표적인 것이 sigmoid함수를 ReLU 함수로 바꾸는 것에 관한 것이다. Sigmoid함수 양쪽의 기울기가 0에 수렴하는 부분은 머신러닝에서 sigmoid함수를 처리하는 것을 매우 어렵게했는데, ReLU가 이르르 해결해주었기 때문이다.
